...
embedder/server.py
------------------
Host-local FastAPI microservice that owns the BGE-M3 singleton.

Why a separate process
----------------------
Both the topic worker and the QA service need to embed text. Loading bge-m3
...
from src.infra.embeddings import EMBED_DIM, embed_texts_async
